<div class="text-center">
   <form wire:submit.prevent="submitQuiz">
    ...
    <button class="btn btn-primary bg-primary block " style="margin-top: 100px;position: absolute;left:50%;transform: translateX(-100%)" type="submit">إضافة الأسئلة للإختبار النهائى</button>
